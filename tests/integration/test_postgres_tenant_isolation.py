...
async def _exercise_isolation() -> None:
    ...
    try:
        ...
        assert [row["relname"] for row in tenant_tables] == [
            ...
            "content_deletion_proof",
            "content_deletion_request",
            "content_retention_change",
            "content_retention_policy",
            "cost_ledger",
            "eval_canary_observation",
            "eval_run",
            "eval_suite",
            ...
            "policy_bundle",
            "reply_delivery",
            "reply_delivery_attempt",
            "session_event",
            "session_lease",
            "session_summary",
            "storage_migration",
            "storage_migration_checkpoint",
            "storage_profile",
            "tool_approval",
            "tool_call",
